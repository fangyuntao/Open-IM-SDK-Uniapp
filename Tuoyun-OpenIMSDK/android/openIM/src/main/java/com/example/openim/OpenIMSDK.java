...
public class OpenIMSDK extends UniModule {
    ...
    public String createImageMessageByURL(String OperationID, JSONObject options) {
        ...
        return Open_im_sdk.createImageMessageByURL(OperationID, jsonStr1, jsonStr2, jsonStr3,options.getString("sourcePath"));
    }
...
//                OpenIMSDK.this.mUniSDKInstance.fireGlobalEventCallback("sendMessageSuccess", params);
        ...
        Open_im_sdk.sendMessage(sendMsgCallBack, operationID,messageStr, options.getString("recvID"), options.getString("groupID"), offlinePushInfoStr);
    }
...
//                OpenIMSDK.this.mUniSDKInstance.fireGlobalEventCallback("sendMessageSuccess", params);
        ...
        Open_im_sdk.sendMessageNotOss(sendMsgNotOssCallBack, operationID, messageStr, options.getString("recvID"), options.getString("groupID"), offlinePushInfoStr);
    }
    ...
    public void addBlack(String operationID, String userID, UniJSCallback callback) {
        Open_im_sdk.addBlack(new BaseImpl(callback), operationID, userID);
    }
    ...
    public void joinGroup(String operationID, JSONObject options, UniJSCallback callback) {
        Open_im_sdk.joinGroup(new BaseImpl(callback), operationID, options.getString("groupID"), options.getString("reqMsg"),options.getInteger("joinSource"));
    }
    ...
    public void updateFcmToken(String operationID,JSONArray userIDList, UniJSCallback callback) {
        Open_im_sdk.updateFcmToken(new BaseImpl(callback), operationID,userIDList.toJSONString());
    }
    ...
    public void uploadLogs(String operationID, JSONArray data, UniJSCallback callback) {
        Open_im_sdk.uploadLogs(new BaseImpl(callback), operationID,data.toJSONString());
    }
