...
- (NSString *)createImageMessageByURL:(NSString *)opid options:(NSDictionary *)options {
    ...
    return Open_im_sdkCreateImageMessageByURL(opid, [sourcePicture json], [bigPicture json], [snapshotPicture json],[options valueForKey:@"sourcePath"]);
}
...
- (void)sendMessage:(NSString *)opid options:(NSDictionary *)options callback:(UniModuleKeepAliveCallback)callback {
    ...
    Open_im_sdkSendMessage(proxy,opid, [message json], [options valueForKey:@"recvID"], [options valueForKey:@"groupID"], [offlinePushInfo json]);
}
...
- (void)sendMessageNotOss:(NSString *)opid options:(NSDictionary *)options callback:(UniModuleKeepAliveCallback)callback {
    ...
    NSDictionary* offlinePushInfo = [options valueForKey:@"offlinePushInfo"];
    SendMessageCallbackProxy *proxy = [[SendMessageCallbackProxy alloc] initWithMessage:message module:self callback:callback];
    Open_im_sdkSendMessageNotOss(proxy,opid, [message json], [options valueForKey:@"recvID"], [options valueForKey:@"groupID"], [offlinePushInfo json]);
}

UNI_EXPORT_METHOD(@selector(findMessageList:findOptions:callback:))

- (void)findMessageList:(NSString *)opid findOptions:(NSDictionary *)findOptions callback:(UniModuleKeepAliveCallback)callback {
    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
...
//UNI_EXPORT_METHOD(@selector(setConversationIsMsgDestruct:options:callback:))
//
//- (void)setConversationIsMsgDestruct:(NSString *)opid options:(NSDictionary *)options callback:(UniModuleKeepAliveCallback)callback {
//    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
//    Open_im_sdkSetConversationIsMsgDestruct(proxy, opid, [options valueForKey:@"conversationID"], [[options valueForKey:@"isMsgDestruct"] boolValue]);
//}
//
//UNI_EXPORT_METHOD(@selector(setConversationMsgDestructTime:options:callback:))
//
//- (void)setConversationMsgDestructTime:(NSString *)opid options:(NSDictionary *)options callback:(UniModuleKeepAliveCallback)callback {
//    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
//    Open_im_sdkSetConversationMsgDestructTime(proxy, opid, [options valueForKey:@"conversationID"], [[options valueForKey:@"msgDestructTime"] intValue]);
//}
...
UNI_EXPORT_METHOD(@selector(addBlack:blackUserID:callback:))

- (void)addBlack:(NSString *)opid blackUserID:(NSString *)blackUserID callback:(UniModuleKeepAliveCallback)callback {
    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
    Open_im_sdkAddBlack(proxy, opid, blackUserID);
}
...
- (void)joinGroup:(NSString *)opid options:(NSDictionary *)options callback:(UniModuleKeepAliveCallback)callback {
    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
    Open_im_sdkJoinGroup(proxy,opid,[options valueForKey:@"groupID"], [options valueForKey:@"reqMsg"],[[options valueForKey:@"joinSource"] intValue] );
}
...
UNI_EXPORT_METHOD(@selector(updateFcmToken:userIDList:callback:))

- (void)updateFcmToken:(NSString *)opid userIDList:(NSArray *)userIDList callback:(UniModuleKeepAliveCallback)callback {
    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
    Open_im_sdkUpdateFcmToken(proxy,opid,[userIDList json]);
}
...
- (void)uploadLogs:(NSString *)opid data:(NSArray *)data callback:(UniModuleKeepAliveCallback)callback {
    CallbackProxy *proxy = [[CallbackProxy alloc] initWithCallback:callback];
    Open_im_sdkUploadLogs(proxy,opid,[data json]);
}
